...
<br>
<a href="newPlayer">
<button type="button" class="btn btn-primary" style="float: right">New Player</button></a>
<#list entries>
    <table style="float: none; font-size: 25px" width="80%" class="table table-hover"  >
        ...
        <#items as entry>
            <tr>
                ...
                <td>${entry.name}</td>
                <td>${entry.age}</td>
                <td><#if entry.team gt 0>
                        ${entry.team}
                    <#else>

                    </#if>
                </td>
                <td><a href="editPlayer/${entry.id}"><button type="button" class="btn btn-primary">
                            Edit</button> </a></td>
            </tr>
        </#items>
    </table>
